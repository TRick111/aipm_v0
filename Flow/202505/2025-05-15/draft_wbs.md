...
1. 計画
   1.1 プロジェクト準備
       1.1.1 要求の整理 {due: 2025-04-15}   完了済み
       1.1.2 要件定義書の作成 {due: 2025-04-16}   完了済み
       1.1.3 システム構成方針作成 {due: 2025-04-17}   完了済み
       1.1.4 タスク一覧化 {due: 2025-04-18}   完了済み
       1.1.5 開発環境のセットアップ {due: 2025-04-19}   完了済み
       1.1.6 AWS 環境の初期セットアップ {due: 2025-04-20}   完了済み
       1.1.7 Git レポジトリの作成 {due: 2025-04-21}   完了済み
   1.2 要件分析・設計
       1.2.1 システムアーキテクチャの設計 {due: 2025-04-22}   完了済み
       1.2.2 使用ライブラリ・フレームワーク選定 {due: 2025-04-23}   完了済み
       1.2.3 データベース設計 {due: 2025-04-24}   完了済み
...
2. 開発
   2.1 バックエンド開発
       ...
       2.1.3 店舗・設備管理 API {due: 2025-05-23}
           2.1.3.1 店舗グループ管理 API 実装
           2.1.3.2 店舗管理 API 実装
           2.1.3.3 設備管理 API 実装
           2.1.3.4 従業員管理 API 実装
       ...
       2.1.7 セキュリティ対策 {due: 2025-06-10}
           ...
           2.1.7.3 HTTPS 有効化確認
   2.2 フロントエンド開発
       2.2.1 モックアップフェーズ (v0) {due: 2025-05-03}   完了済み
           2.2.1.1 ワイヤーフレーム作成   完了済み
           2.2.1.2 モックアップ作成   完了済み
           2.2.1.3 UI/UX レビュー   完了済み
       2.2.2 モノレポ構成移行 {due: 2025-05-08}   完了済み
           2.2.2.1 TurboRepo/PNPM Workspace 設定   完了済み
           2.2.2.2 モックアップをモノレポへ移行   完了済み
       ...
       2.2.4 カレンダー・履歴機能 {due: 2025-06-20}
           ...
           2.2.4.2 一括入力機能実装
   2.3 AWS インフラ構築
       2.3.1 AWS アカウント・組織設定 {due: 2025-05-12}   完了済み
       2.3.2 IAM ロール・ポリシー設計 {due: 2025-05-13}
       2.3.3 VPC & サブネット設計 {due: 2025-05-14}
       2.3.4 S3 バケット作成 {due: 2025-05-15}
       2.3.5 RDS Proxy 設定 {due: 2025-05-16}
