...
# run_pipeline.py で period を以下に揃える：
# - Before = 期間A（2025年1-3月）
# - After  = 期間B（2025年10-12月）
segment_labels = {
    'Before_Lunch': '期間A(1-3月)・ランチ',
    'Before_Dinner': '期間A(1-3月)・ディナー',
    'After_Lunch': '期間B(10-12月)・ランチ',
    'After_Dinner': '期間B(10-12月)・ディナー'
}
segment_colors = {
