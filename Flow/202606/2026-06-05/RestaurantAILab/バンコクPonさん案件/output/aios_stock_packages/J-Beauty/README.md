...
> PONさん側 Stock に既に `J-Beauty` Program の README.md がある場合は、そちらを優先してください。
> 既存がない場合のみ、このサンプルを参考に追加してください。

## 背景・目的

J-Beauty に関する PONさん側の Program です。Rios Innovation Co., Ltd. が展開する J-Beauty 事業全体のナレッジを保持します。
