...
-   Stock/RestaurantAILab/ChefsRoom マーケティング支援/1.PoC/examples.yaml ファイルを必ず参照し、
    -   構成
    -   トーン
    -   長さ
    -   言い回し
...
Stock/RestaurantAILab/ChefsRoom マーケティング支援/1.PoC/input.md
...
-   セリフ案を、Stock/RestaurantAILab/ChefsRoom マーケティング支援/1.PoC/examples.yaml ファイルのトーン・構成・長さを厳密に模倣して出力してください。
-   口語的・親しみやすい表現を徹底すること。
