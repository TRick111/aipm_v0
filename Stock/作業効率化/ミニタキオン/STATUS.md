...
- [ ] **BL-TBD-005 Phase 3b: 🌙 夜の振り返り** — Cockpit task 976dc72a で実装中 (並列1)
- [ ] **BL-TBD-009 ミニタキオン UI 拡張: 中央 Backlog.md 読込** — Cockpit task b0c9e231 で実装中 (並列2)
- [ ] **BL-TBD-006 Phase 3c: cron + 承認後自動更新** — 未着手 (3b/009 完了後)
- [ ] **BL-TBD-007 Phase 3d: 「📅 今日の運用」UI 拡張 + 「📚 過去の運用」リンク** — 未着手 (3b/009 完了後)
