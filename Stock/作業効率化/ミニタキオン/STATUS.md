...
- [ ] **BL-TBD-008 Phase 3a v3: 運用フィードバック修正** — Cockpit task a4adcf48 で実装中 (claude agent, 2026-04-26 11:02 開始)
  - Fix 1 (P0): create-fallback コンテキスト同梱 (新エージェントが context 持って動く)
  - Fix 2 (P1): `generating` review_state 追加 (☀️ 直後の「ファイル無し」回避)
  - Fix 3 (P1): needs_revision を AIの番グルーピングへ
- [ ] **BL-TBD-005 Phase 3b: 🌙 夜の振り返り** — planned (3a v3 完了後)
- [ ] **BL-TBD-006 Phase 3c: cron + 承認後自動更新** — 未着手 (3b 完了後)
- [ ] **BL-TBD-007 Phase 3d: 「📅 今日の運用」UI 拡張 + 「📚 過去の運用」リンク** — 未着手 (3a 確定後)
