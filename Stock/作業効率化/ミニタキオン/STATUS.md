...
- [ ] **BL-TBD-011 Phase 4a: API 化 + CLI wrapper (`mt`)** — Cockpit task f285aa69 で実装中 (2026-04-26 19:21 開始)
  - 13+ HTTP API endpoints (BL/deliverable/cockpit/morning/evening/query)
  - `mt` CLI wrapper (Bun script、JSON / human 出力)
  - zod validate + structured error
  - docs/API.md + docs/CLI.md
- [ ] **BL-TBD-012 Phase 4b: prompt の skill 化移行** — pending (BL-TBD-011 完了後)
