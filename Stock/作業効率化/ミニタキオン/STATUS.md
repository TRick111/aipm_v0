...
- [ ] **BL-TBD-004 Phase 3a: ☀️ 朝の整理ボタン** — Cockpit task 83948eeb で v2 修正中 (2026-04-25 23:17 開始)
  - v1 完了 (UI ボタン / セクション / Server Action / プロンプト / vitest 47 pass)
  - **v2 修正中**: 田中さんフィードバック反映
    - データソースを `Stock/定型作業/バックログ/Backlog.md` 中央台帳に切替
    - 出力形式を `Flow/202604/2026-04-24/0424_planning.md` 4/24 planning スタイルに
    - 案件 (Project) ごとのグルーピング + 状況サマリー + 期日順テーブル
    - クラス ABC (🟢A/🟡B/🔴C/⏸️) で実行可否を分類
